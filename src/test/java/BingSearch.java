...
public class BingSearch {
    ...
    //TODO: automated search scenario on BING.com
    @Test
    public void test002() {
    ...
    private void waitForResults () {
        By resultStatsElement = By.className("sb_count");
        WebDriverWait wait = new WebDriverWait(driver, 10);
        wait.until(ExpectedConditions.visibilityOfElementLocated(resultStatsElement));
    }

    private void assertResultPage() {
        WebElement resultStatsElements = driver.findElement(By.className("sb_count"));
    ...
    private void submitSearch() {
        WebElement searchInput = driver.findElement(By.cssSelector("#sb_form_q")); //submit search google
        searchInput.submit();
    }

    private void typeQuery() {
        WebElement searchInput = driver.findElement(By.cssSelector("#sb_form_q")); //insert CSS Selector!!! from google/bing search (google.com/bing.com)
